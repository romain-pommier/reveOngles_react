        ...
        <div>
          <Col className="mt-5 pt-5">
            ...
            <p className="pt-5 text-center description_text">
              ...
              Les ongles sont pour moi une vériatble passion depuis des années.{' '}
              <br />
              Mes expériences: Diplôme CAP esthétique ainsi que 38 certificats
              d'ongles à mon actif, concours, formatrice en France, salon
              d'ongles en France avec la marque avec laquelle je travail.
            </p>
            <h2 className="description_header">
              Prothésiste ongulaire à Labarthe-sur-Lèze
            </h2>
            <p className="pt-5 text-center description_text">
              Je mets un point d'honneur à vous écouter, au moment de la prise
              de rendez-vous et tout au long de votre prestation. De cette
              façon, je peux vous conseiller et vous accompagner dans le choix
              de la technique (extension en gel, remplissage vernis
              semi-permanent, nail art, pose artistiques) sur rendez-vous.
            </p>
          </Col>
        </div>
